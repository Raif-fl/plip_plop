...
RESULTS_DIR=/tscc/lustre/ddn/scratch/kflanagan/RNA_protein_grammar/Stereogene_results/ADARs_IN
...
"$STEREOGENE" \
    ...
    confounder=ADARp110_IN_1.scaled.plus.bedGraph \
...
"$STEREOGENE" \
    ...
    trackPath="$BEDGRAPH_DIR/plus" \
    profPath="$RESULTS_DIR/profiles" \
    confounder=ADARp110_IN_2.scaled.plus.bedGraph \
...
"$STEREOGENE" \
    ...
    profPath="$RESULTS_DIR/profiles" \
    confounder=ADARp110_IN_1.scaled.minus.bedGraph \
...
"$STEREOGENE" \
    ...
    trackPath="$BEDGRAPH_DIR/minus" \
    profPath="$RESULTS_DIR/profiles" \
    confounder=ADARp110_IN_2.scaled.minus.bedGraph \
